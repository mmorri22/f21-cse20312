...
# Spring 2021 - Data Structures - Lecture 17 - Grading Script
...
echo "-----------------------------" >> $SCRIPT_OUT
echo "" >> $SCRIPT_OUT
echo "Lec17 Grade: Earned $STUDENT_GRADE points today "
echo "Lec17 Grade: Earned $STUDENT_GRADE points today " >> $SCRIPT_OUT
